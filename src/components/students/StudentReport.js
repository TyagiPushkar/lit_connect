...
//           const semesters = Array.from({ length: currentSem }, (_, i) =>
//             (i + 1).toString(),
//           );
...
//   //   ) {
//   //     alert(
//   //       `Please select ${selectedCategory === "Class Test" ? "Test Number" : "CBT Number"}`,
//   //     );
//   //     return;
//   //   }
...
//             {/* Assignment Summary */}
//             {allReportsData.Assignment &&
//               allReportsData.Assignment.length > 0 && (
//                 <Grid item xs={12} md={6}>
//                   <Card sx={{ borderRadius: 2, border: "1px solid #e0e0e0" }}>
//                     <CardContent>
//                       <Typography
//                         variant="h6"
//                         sx={{ color: "#CC7A00", mb: 2, fontWeight: 600 }}
//                       >
//                         📋 Assignment Report
//                       </Typography>
//                       <Box sx={{ mb: 2 }}>
//                         {(() => {
//                           const totals = calculateAttendanceTotal(
//                             allReportsData.Assignment,
//                           );
//                           return (
//                             <Box
...
//                                 variant="h4"
//                                 sx={{
//                                   color: getPercentageColor(totals.percentage),
//                                   fontWeight: 700,
//                                 }}
//                               >
...
//                                 Overall Attendance ({totals.totalPresent}/
//                                 {totals.totalClasses})
//                               </Typography>
//                             </Box>
//                           );
...
//                             </Typography>
//                             <Typography variant="body2" color="textSecondary">
//                               Overall Score ({totals.totalObtained}/
//                               {totals.totalMax})
//                             </Typography>
//                           </Box>
//                         );
...
//                           const noOfClasses =
//                             Number.parseInt(row.NoOfClasses) || 0;
//                           const presentClass =
//                             Number.parseInt(row.PresentClass) || 0;
//                           const percentage =
//                             noOfClasses > 0
//                               ? (presentClass / noOfClasses) * 100
//                               : 0;
...
//                         const obtainedMarks =
//                           Number.parseInt(row.ObtainedMarks) || 0;
//                         const percentage =
//                           maxMarks > 0 ? (obtainedMarks / maxMarks) * 100 : 0;
...
//         : calculateAttendanceTotal(reportData);
...
//                   percentage =
//                     noOfClasses > 0 ? (presentClass / noOfClasses) * 100 : 0;
...
//                   <TableRow key={index} hover>
//                     <TableCell>
//                       {reportType === "Assignment" ? row.Month : row.Subject}
//                     </TableCell>
...
//       <ReportCardPDF
//         studentId={studentId}
//         sem={selectedSemester || student?.Sem}
...
function StudentReports() {
  ...
  const renderFilterSection = () => (
    <Paper sx={{ p: 3, mb: 3, borderRadius: 3, boxShadow: 2 }}>
      <Typography
        variant="h6"
        sx={{ color: "#CC7A00", fontWeight: 700, mb: 2 }}
      >
        Select Semester{" "}
      </Typography>
      <FormControl fullWidth size="small">
