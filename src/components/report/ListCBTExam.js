...
function ListCBTExam({ setView }) {
    ...
    const fetchRecords = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://namami-infotech.com/LIT/src/report/list_cbt_exam.php', {
    ...
    const handleSave = async (rowId) => {
        try {
            const { data } = await axios.post('https://namami-infotech.com/LIT/src/report/edit_cbt.php', {
                Id: rowId,
