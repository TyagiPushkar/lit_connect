      ...
      <Paper sx={{ p: 3, mb: 3, borderRadius: 2 }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Autocomplete
                ...
                getOptionLabel={(option) =>
                  `${option.Name} (${option.EmpId || option.StudentId})`
                }
                value={
                  (viewType === "employee"
                    ? employees.find((emp) => emp.EmpId === selectedEmpId)
                    : students.find(
                        (stu) => stu.StudentId === selectedEmpId,
                      )) || null
                }
                onChange={(event, newValue) => {
                  console.log("Selection changed:", newValue);
                  setSelectedEmpId(
                    newValue ? newValue.EmpId || newValue.StudentId : "",
                  );
                  ...
                  <Box component="li" {...props}>
                    ...
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        {option.EmpId || option.StudentId} •
                        {viewType === "employee"
                          ? ` Week Off: ${option.WeekOff || "Not set"}`
                          : " Student"}
                      </Typography>
                    </Box>
                  </Box>
        ...
        >
          ...
          >
            ...
            {selectedEmployee &&
              ` • ${viewType === "employee" ? "Employee" : "Student"}: ${selectedEmployee.Name}`}
          </Typography>
        </Box>
      </Paper>
          ...
          >
            <CardContent>
              ...
              >
                ...
                <Badge
                  badgeContent={`${holidayCount + weekOffCount + leaveCount}`}
                  color="warning"
                >
